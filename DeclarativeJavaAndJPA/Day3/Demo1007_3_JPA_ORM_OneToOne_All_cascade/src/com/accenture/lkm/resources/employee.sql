...
drop database IF EXISTS jpamappingdemos_onetoone_cascadetype2;
create database jpamappingdemos_onetoone_cascadetype2;
use jpamappingdemos_onetoone_cascadetype2;
...
CREATE TABLE IF NOT EXISTS `employee` (
  ...
  KEY `FK_ruw7ch0hue0wgooxh2su5edyk` (`assetId_fk`),
  CONSTRAINT `FK_ruw7ch0hue0wgooxh2su5edyk` FOREIGN KEY (`assetId_fk`) REFERENCES `assets` (`assetId`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;
